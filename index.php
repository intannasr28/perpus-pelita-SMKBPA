...
<head>
	...
	<title>SISTEM INFORMASI PERPUSTAKAAN PELITA</title>
...
<body class="hold-transition skin-navy sidebar-mini">
	<!-- Site wrapper -->
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-mini">
					<img src="<?php echo $school_logo_path; ?>" style="width:30px; height:auto;">
				</span>
				<span class="logo-lg">
					<img src="<?php echo $school_logo_path; ?>" width="37px" style="vertical-align:middle; margin-right:8px;">
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										Perpustakaan Elektronik Berbasis Web V 1.0
									</b>
								</span>
							</a>
						</li>
